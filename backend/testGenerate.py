...
from api.models import Constraint, Course
from api.serializers import ConstraintSerializer, CourseSerializer
...
constraints_data = ConstraintSerializer(constraints.first()).data
courses_data = CourseSerializer(courses, many=True).data

print(constraints_data)
print(courses_data)